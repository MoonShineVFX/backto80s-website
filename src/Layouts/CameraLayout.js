...
function CameraLayout() {
  ...
  const images = [
    {
      url: "https://r2.web.moonshine.tw/msweb/backto80s_ai/icon08.png",
      top: "-19%",
      left: "11%",
      width: "18%",
      mobile: { top: "0%", left: "-3%", width: "28%" },
    },
    {
      url: "https://r2.web.moonshine.tw/msweb/backto80s_ai/icon01.png",
      top: "-10%",
      left: "-6%",
      width: "23%",
      mobile: { top: "25%", left: "-6%", width: "33%" },
    },
    {
      url: "https://r2.web.moonshine.tw/msweb/backto80s_ai/icon02.png",
      top: "30%",
      left: "7%",
      width: "12%",
      mobile: { top: "50%", left: "-1%", width: "20%" },
    },
    {
      url: "https://r2.web.moonshine.tw/msweb/backto80s_ai/icon03.png",
      top: "65%",
      left: "-6%",
      width: "30%",
      mobile: { top: "80%", left: "-3%", width: "45%" },
    },
    {
      url: "https://r2.web.moonshine.tw/msweb/backto80s_ai/icon04.png",
      top: "-15%",
      left: "75%",
      width: "30%",
      mobile: { top: "0%", left: "75%", width: "35%" },
    },
    {
      url: "https://r2.web.moonshine.tw/msweb/backto80s_ai/icon05.png",
      top: "25%",
      left: "70%",
      width: "15%",
      mobile: { top: "25%", left: "75%", width: "35%" },
    },
    {
      url: "https://r2.web.moonshine.tw/msweb/backto80s_ai/icon06.png",
      top: "45%",
      left: "76%",
      width: "18%",
      mobile: { top: "50%", left: "73%", width: "34%" },
    },
    {
      url: "https://r2.web.moonshine.tw/msweb/backto80s_ai/icon07.png",
      top: "70%",
      left: "76%",
      width: "28%",
      mobile: { top: "80%", left: "60%", width: "45%" },
    },
  ];
    ...
    >
      <div className="w-full   flex flex-col  md:h-auto justify-between   relative">
        ...
        <div
          className={`${
            isMobile ? "h-full " : ""
          } flex flex-col w-full mx-auto  items-center md:mt-0 relative `}
        >
          <Outlet />
        </div>
      </div>
      {location.pathname === "/" && (
        <div className="bg-black/0 absolute w-full h-full top-0 -z-10  overflow-hidden">
